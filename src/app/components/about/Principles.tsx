            ...
            {principles.map((p, i) => (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 md:items-baseline">
                  <span className="text-gold font-serif text-2xl opacity-50 group-hover:opacity-100 transition-opacity">
                    0{i + 1}
                  </span>
                  <div>
                    <h3 className="font-serif text-3xl mb-4 text-cream group-hover:text-gold transition-colors">
                      {p.title}
                    </h3>
